...
<body>
                    ...
                    <div class="form-group">
                        ...
                        <div class="select-container">
                            <select id="irrH" name="irrH" required>
                                ...
                                <option value="8">8 veces al día</option>
                                <option value="12">12 veces al día</option>
                                <option value="24">24 veces al día</option>
                            </select>
                        </div>
                    </div>
    ...
    <script>
        ...
        var valoresESP32 = {
            nombrePlanta: "Albahaca",
            dispositivoActivo: true,
            fotoperiodo: 18,
            fotoperiodoApagado: 6,
            luzAzul: 70,
            luzRoja: 45,
            luzBlanca: 30,
            horasIrrigacion: 3,
            minutosIrrigacion: 15,
            horasVentilador: 4,
            minutosVentilador: 20,
            semana: 4,
            dia: 26,
            hasRegisteredUser: true,
        }

        const VALID_FREQUENCIES = [0, 1, 2, 3, 4, 6, 8, 12, 24];

        const FREQ_LABELS = {
            0: "0 × día", 1: "1 × día", 2: "2 × día", 3: "3 × día", 4: "4 × día",
            6: "6 × día", 8: "8 × día", 12: "12 × día", 24: "24 × día"
        };
        ...
        async function cargarParametros() {
            ...
            actualizarDashboard();
            if (valoresESP32.hasRegisteredUser) {
                setEstado("view");
            } else {
                setEstado("register");
        ...
        function actualizarFormulario() {
            ...
            document.getElementById('ledB').checked = Number(valoresESP32.luzBlanca) > 0;
        ...
        function actualizarDashboard() {
            ...
            document.getElementById('dashPlanta').textContent = v.nombrePlanta || "Sin nombre";
        ...
        function setDashLedB(val) {
            ...
            document.getElementById('dashLedB').textContent = on ? "ON" : "OFF";
        }
        ...
        function setEstado(nuevo) {
            ...
            if (nuevo === "view") {
                ...
                stepper.style.display = "none";
                cardTitle.textContent = "Crea tu usuario y contraseña";
        ...
        form.addEventListener("submit", function (e) {
            ...
            data['diaSem'] = Number(fechaHoraActual.getDay()) + 1; // getDay() es 0-6 (dom=0); el ESP32 espera 1-7
