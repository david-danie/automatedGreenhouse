...
<body>
        ...
        <form id="mainForm" novalidate>
            ...
            <div id="stepParams" style="display:none;">
                ...
                <div class="light-primary">
                    <label class="light-primary-toggle" for="ledBlanco">
                ...
                <details class="light-advanced">
                    ...
                    <div class="light-advanced-body">
                        <div class="form-group">
                            <label for="ledAzul">Espectro Azul: <span id="luzAzulValue">50%</span></label>
                        ...
                        <div class="form-group">
                            <label for="ledRojo">Espectro Rojo: <span id="luzRojaValue">50%</span></label>
                            <div class="slider-container">
    ...
    <script>
        ...
        function actualizarFormulario() {
            ...
            document.getElementById('ledAzul').value = p.ledAzul;
            document.getElementById('luzAzulValue').innerText = `${p.ledAzul}%`;
            document.getElementById('ledRojo').value = p.ledRojo;
            document.getElementById('luzRojaValue').innerText = `${p.ledRojo}%`;
            document.getElementById('ledBlanco').checked = Number(p.ledBlanco) > 0;
            ...
            updateSliderProgress('ledAzul', 'progressA');
            updateSliderProgress('ledRojo', 'progressR');
            const adv = document.querySelector('.light-advanced');
            if (adv) adv.open = Number(p.ledAzul) > 0 || Number(p.ledRojo) > 0;
        }
        function actualizarDashboard() {
            ...
            setDashLed('dashLedR', p.ledRojo);
            setDashLedB(p.ledBlanco);
        ...
        function validarParametros() {
            ...
            const ledAzulInput = document.getElementById("ledAzul").value.trim();
            const ledRojoInput = document.getElementById("ledRojo").value.trim();
            if (planta === "") {
        ...
        function updateSliderProgress(sliderId, progressId) {
            ...
            let color;
            if (sliderId === 'ledAzul') color = '#2196F3';
            else if (sliderId === 'ledRojo') color = '#f44336';
        ...
        updateLampValue('ledAzul', 'luzAzulValue', 'progressA');
        updateLampValue('ledRojo', 'luzRojaValue', 'progressR');
    </script>
</body>
</html>
)===";
